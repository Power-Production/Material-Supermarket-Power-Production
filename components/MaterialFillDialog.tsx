...
export function MaterialFillDialog({ 
  ...
  const handleConfirmFill = () => {
    ...
    // Add database functions for fill material
    // dbFunctions.saveMaterial(material, selectedBin, quantity);
    // dbFunctions.saveHistory(material, selectedBin, quantity, "fill");
